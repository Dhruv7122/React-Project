...
const Navbar = () => {
  ...
  return (
    <header className="text-blue-950 body-font bg-gray-800">
        ...
        <div className="flex items-center mb-4 md:mb-0">
          <Link to="/" className="flex align-middle items-center text-white">
            ...
            <div className="ml-3 text-center">
              <span className="text-4xl font-regular text-white text-center" style={{ fontFamily: 'Georgia, serif' }}>My E-Commerce Site</span>
            </div>
          </Link>
        </div>
